...
int main(int argc, char* args[])
{
    ...
    if(IsInitialized)        // Start The Game
    {
        ...
        LoadSprite(TextureCache[0], SpriteCache, 1, 10000);
        SpriteCache.find(1)->Sprite.DestinationRectangle.x = 300;
        SpriteCache.find(1)->Sprite.DestinationRectangle.y = 300;
        LoadSprite(TextureCache[0], SpriteCache, 2, 10000);
        SpriteCache.find(2)->Sprite.DestinationRectangle.x = 150;
        SpriteCache.find(2)->Sprite.DestinationRectangle.y = 150; 
