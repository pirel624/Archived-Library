...
/*
TO DO:
1. Fix sprite_map class
2. Fix LoadSprite() function
*/
...
class sprite_map
{
    ...
    bool insert(unsigned int key, sprite Sprite)
    {
...
bool LoadSprite(SDL_Texture* ptexture, sprite_map SpriteCache, unsigned int key)
{
    ...
    SpriteCache.insert(key, buffer_sprite);
    return true;
}
...
int main(int argc, char* args[])
{
    ...
    if(IsInitialized)        // Start The Game
    {
        ...
        LoadSprite(TextureCache[0], SpriteCache, 1);
        ...
        while(true)
        {
            ...
            SDL_RenderCopy(renderer, SpriteCache.find(1)->Sprite.pTexture, &SpriteCache.find(1)->Sprite.SourceRectangle, &SpriteCache.find(1)->Sprite.DestinationRectangle);
