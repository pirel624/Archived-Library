...
class hitbox // rewrite this motherfucker !!
{
    private:
    int CenterX;
    int CenterY;
...
int main(int argc, char* args[])
{
    ...
    {
        hitbox collider1(100, 100, 30, 30, 'C');
        hitbox collider2(161, 100, 30, 30, 'C');
        
        /*
        std::cout << hitbox::IsColliding(collider1, collider2) << std::endl;
        std::cout << "Center X1 : " << collider1.GetCenterX() << std::endl;
        std::cout << "Center Y1 : " << collider1.GetCenterY() << std::endl;
        std::cout << "Center X2 : " << collider2.GetCenterX() << std::endl;
        std::cout << "Center Y2 : " << collider2.GetCenterY() << std::endl;
        ...
        std::cout << "Center Y2 : " << collider2.GetCenterY() << std::endl;
        std::cout << '\n';
        std::cout << "X  =  " << collider1.GetSDLRect().x << std::endl;
        std::cout << "Y  =  " << collider1.GetSDLRect().y << std::endl;
        std::cout << "W  =  " << collider1.GetSDLRect().w << std::endl;
        std::cout << "H  =  " << collider1.GetSDLRect().h << std::endl;
        while(true){}
